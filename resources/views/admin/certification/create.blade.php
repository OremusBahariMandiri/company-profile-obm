...
<div class="fade-in">
    ...
    <div class="dashboard-card">
        <div class="card-header">
            <i class="fas fa-edit me-2"></i>Form Tambah Sertifikat
        </div>
        <div class="card-body">
            <form action="{{ route('certification.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-6 mb-3">
                        <label for="photo" class="form-label">Foto Sertifikat <span class="text-danger">*</span></label>
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <textarea class="form-control @error('description') is-invalid @enderror"
                                  ...
                                  placeholder="Tulis deskripsi lengkap sertifikat, termasuk detail seperti penerbit, tanggal berlaku, cakupan, dll...">{{ old('description') }}</textarea>
