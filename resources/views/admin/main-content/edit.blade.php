...
@section('title', 'Edit Konten Utama')
...
<div class="fade-in">
    ...
    <div class="dashboard-card">
        <div class="card-header">
            <i class="fas fa-edit me-2"></i>Form Edit Konten Utama
        </div>
        <div class="card-body">
            <form action="{{ route('main-content.update', $mainContent) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('title_1') is-invalid @enderror"
                               id="title_1" name="title_1" value="{{ old('title_1', $mainContent->title_1) }}" required>
                        @error('title_1')
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <textarea class="form-control @error('subtitle_1') is-invalid @enderror"
                                  id="subtitle_1" name="subtitle_1" rows="3" required>{{ old('subtitle_1', $mainContent->subtitle_1) }}</textarea>
                        @error('subtitle_1')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('title_2') is-invalid @enderror"
                               id="title_2" name="title_2" value="{{ old('title_2', $mainContent->title_2) }}" required>
                        @error('title_2')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <textarea class="form-control @error('subtitle_2') is-invalid @enderror"
                                  id="subtitle_2" name="subtitle_2" rows="3" required>{{ old('subtitle_2', $mainContent->subtitle_2) }}</textarea>
                        @error('subtitle_2')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('title_3') is-invalid @enderror"
                               id="title_3" name="title_3" value="{{ old('title_3', $mainContent->title_3) }}" required>
                        @error('title_3')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <textarea class="form-control @error('subtitle_3') is-invalid @enderror"
                                  id="subtitle_3" name="subtitle_3" rows="3" required>{{ old('subtitle_3', $mainContent->subtitle_3) }}</textarea>
                        @error('subtitle_3')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
        ...
        if (input) {
            input.addEventListener('change', function(e) {
                ...
                if (file) {
                    ...
                    const existingPreview = input.parentNode.querySelector('.mt-2');
                    let preview;
                    ...
                    reader.onload = function(e) {
                        preview.innerHTML = `
                            ...
                            <p class="small text-success mt-1">
                                <i class="fas fa-check me-1"></i>Foto baru dipilih
                            </p>
                        `;
                    };
