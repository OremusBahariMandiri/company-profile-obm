...
@section('title', 'Tambah Konfigurasi Tim')
...
<div class="fade-in">
    ...
    <div class="dashboard-card">
        <div class="card-header">
            <i class="fas fa-edit me-2"></i>Form Tambah Konfigurasi Tim
        </div>
        <div class="card-body">
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('title_photo_1') is-invalid @enderror"
                               id="title_photo_1" name="title_photo_1" value="{{ old('title_photo_1') }}" required
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('subtitle_photo_1') is-invalid @enderror"
                               id="subtitle_photo_1" name="subtitle_photo_1" value="{{ old('subtitle_photo_1') }}" required
                    ...
                    <div class="col-12 mb-3">
                        <label for="photo_1" class="form-label">Foto Tim Utama <span class="text-danger">*</span></label>
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('title_photo_2') is-invalid @enderror"
                               id="title_photo_2" name="title_photo_2" value="{{ old('title_photo_2') }}"
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('subtitle_photo_2') is-invalid @enderror"
                               id="subtitle_photo_2" name="subtitle_photo_2" value="{{ old('subtitle_photo_2') }}"
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('title_photo_3') is-invalid @enderror"
                               id="title_photo_3" name="title_photo_3" value="{{ old('title_photo_3') }}"
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('subtitle_photo_3') is-invalid @enderror"
                               id="subtitle_photo_3" name="subtitle_photo_3" value="{{ old('subtitle_photo_3') }}"
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Auto-fill functionality: when user fills team 2 titles, make photo required
    const titlePhoto2 = document.getElementById('title_photo_2');
    const subtitlePhoto2 = document.getElementById('subtitle_photo_2');
    const photo2 = document.getElementById('photo_2');

    function checkRequiredPhoto2() {
        if (titlePhoto2.value.trim() || subtitlePhoto2.value.trim()) {
            photo2.setAttribute('required', 'required');
            const label2 = document.querySelector('label[for="photo_2"]');
            if (label2 && !label2.innerHTML.includes('*')) {
                label2.innerHTML = label2.innerHTML.replace('Foto Tim Kedua', 'Foto Tim Kedua <span class="text-danger">*</span>');
            }
        } else {
            photo2.removeAttribute('required');
            const label2 = document.querySelector('label[for="photo_2"]');
            if (label2) {
                label2.innerHTML = 'Foto Tim Kedua';
            }
        }
    }

    // Auto-fill functionality: when user fills team 3 titles, make photo required
    const titlePhoto3 = document.getElementById('title_photo_3');
    const subtitlePhoto3 = document.getElementById('subtitle_photo_3');
    const photo3 = document.getElementById('photo_3');

    function checkRequiredPhoto3() {
        if (titlePhoto3.value.trim() || subtitlePhoto3.value.trim()) {
            photo3.setAttribute('required', 'required');
            const label3 = document.querySelector('label[for="photo_3"]');
            if (label3 && !label3.innerHTML.includes('*')) {
                label3.innerHTML = label3.innerHTML.replace('Foto Tim Ketiga', 'Foto Tim Ketiga <span class="text-danger">*</span>');
            }
        } else {
            photo3.removeAttribute('required');
            const label3 = document.querySelector('label[for="photo_3"]');
            if (label3) {
                label3.innerHTML = 'Foto Tim Ketiga';
            }
        }
    }

    if (titlePhoto2 && subtitlePhoto2) {
        titlePhoto2.addEventListener('input', checkRequiredPhoto2);
        subtitlePhoto2.addEventListener('input', checkRequiredPhoto2);
    }

    if (titlePhoto3 && subtitlePhoto3) {
        titlePhoto3.addEventListener('input', checkRequiredPhoto3);
        subtitlePhoto3.addEventListener('input', checkRequiredPhoto3);
    }
});
</script>
@endpush