...
<div class="fade-in">
    ...
    <div class="dashboard-card">
        <div class="card-header">
            <i class="fas fa-edit me-2"></i>Form Tambah Lowongan Karir
        </div>
        <div class="card-body">
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('careers_name') is-invalid @enderror"
                               id="careers_name" name="careers_name" value="{{ old('careers_name') }}" required
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('working_area') is-invalid @enderror"
                               id="working_area" name="working_area" value="{{ old('working_area') }}" required
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <textarea class="form-control @error('description') is-invalid @enderror"
                                  ...
                                  placeholder="Tulis deskripsi lengkap lowongan karir...">{{ old('description') }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('sallary') is-invalid @enderror"
                               id="sallary" name="sallary" value="{{ old('sallary') }}"
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('spesification_'.$i) is-invalid @enderror"
                               id="spesification_{{ $i }}" name="spesification_{{ $i }}" value="{{ old('spesification_'.$i) }}"
