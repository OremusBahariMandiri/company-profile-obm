...
@section('content')
    ...
    <section class="director-section" id="about">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-5 mb-5 mb-lg-0" data-aos="fade-right" data-aos-delay="100" data-aos-offset="300" data-aos-once="false">
                    <div class="position-relative" style="transform: scaleX(-1);">
                        <img src="{{ asset($director['image'] ?? 'images/direktur.png') }}" alt="Director" class="img-fluid director-img">
                        <i class="fas fa-quote-left quote-icon"></i>
                    </div>
                </div>
                <div class="col-lg-7" data-aos="fade-left" data-aos-delay="200" data-aos-offset="300" data-aos-once="false">
                    <h2 class="section-title mb-4 text-center">{{ $director['message']['greeting'] ?? 'Dear Valued Agents,' }}</h2>
                    ...
                    @else
                        ...
                        <p>Our comprehensive services – including ship handling, provision supply, medivac operations, and crew change – are tailored to meet the dynamic needs of the shipping industry. Backed by an experienced and responsive team, we ensure seamless coordination, safety, and efficiency in every port call.</p>
                        <p>At PT. Oremus Bahari Mandiri, we believe in forging lasting partnerships and providing more than just services – we deliver dependable solutions that move your operations forward. Thank you for your continued trust. We look forward to navigating new horizons together.</p>
                    @endif

                    <div class="mt-4">
                        <p class="mb-2" style="font-weight: 600; color: var(--dark-blue);">{{ $director['name'] ?? 'Niko Kristanto' }}</p>
                        <p class="mb-0" style="color: var(--ocean-green);">{{ $director['position'] ?? 'President Director' }}</p>
                        <p class="mb-0" style="color: var(--ocean-blue);">{{ $director['company'] ?? 'PT. Oremus Bahari Mandiri' }}</p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    @foreach($services as $index => $service)
                        <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="{{ ($index + 1) * 100 }}">
                            <div class="service-card text-center p-4">
                                <div class="service-icon" style="background-color: {{ $service['color'] }}; margin-top:5px">
                                    <i class="fas {{ $service['icon'] }}"></i>
                                </div>
                                <h4 class="mb-3" style="color: var(--dark-blue);">{{ $service['title'] }}</h4>
                                <p>{{ $service['description'] }}</p>
                                <a href="#contact" class="btn mt-3" style="background-color: var(--dark-blue); color: white;">Learn More</a>
                            </div>
                        </div>
                    @endforeach
                @else
                    ...
                    <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="100">
                        <div class="service-card text-center p-4">
                            ...
                            <p>Comprehensive ship handling services including general agency, local agency, and owner protection across all Indonesian ports for various vessel types.</p>
                            <a href="#contact" class="btn mt-3" style="background-color: var(--dark-blue); color: white;">Learn More</a>
                        </div>
                    </div>
                @endif
                        ...
                        @if($achievement['position'] === 'right')
                            ...
                            <div class="col-lg-6 order-lg-2 order-1 mb-4 mb-lg-0" data-aos="fade-left" data-aos-delay="300">
                                <div class="achievement-img">
                                    <img src="{{ $achievement['image'] }}" alt="Achievement {{ $index + 1 }}" class="img-fluid" style="width: 100%; height: auto;">
                                </div>
                            </div>
                        @else
                            <!-- Image Column (Left) -->
                            <div class="col-lg-6 order-lg-1 order-1 mb-4 mb-lg-0" data-aos="fade-right" data-aos-delay="200">
                                <div class="achievement-img">
                                    <img src="{{ $achievement['image'] }}" alt="Achievement {{ $index + 1 }}" class="img-fluid" style="width: 100%; height: auto;">
                                </div>
                            </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8 text-center">
                        <div class="achievement-placeholder py-5">
                            <i class="fas fa-trophy" style="font-size: 4rem; color: var(--ocean-green); opacity: 0.3; margin-bottom: 2rem;"></i>
            ...
            <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 mb-4" data-aos="fade-up" data-aos-delay="{{ ($index + 1) * 100 }}">
                            <div class="certificate-card">
                                <div class="certificate-image">
                                    <img src="{{ $certificate['image'] }}" alt="{{ $certificate['title'] }}" class="img-fluid">
                ...
                @else
                    ...
                    <div class="col-lg-4 col-md-6 mb-4" data-aos="fade-up" data-aos-delay="100">
                        <div class="certificate-card">
                            <div class="certificate-image">
                                <img src="{{ asset('images/certificates/iso-9001.jpg') }}" alt="ISO 9001:2015" class="img-fluid">
                                <div class="certificate-overlay">
                                    <div class="certificate-icon">
        ...
        <div class="container">
            ...
            <div class="news-container">
                ...
                <div class="view-all-news">
                    <a href="{{ route('publicnews.index') }}" class="view-all-btn">View All News <i class="fas fa-external-link-alt"></i></a>
                </div>
            </div>
        </div>
    </section> --}}
            ...
            <div class="row">
                @if(isset($team) && count($team) > 0)
                    @foreach($team as $index => $member)
                        <div class="@if($member['size'] === 'full') col-12 mb-5 @else col-md-6 @endif" data-aos="fade-up" data-aos-delay="{{ ($index + 1) * 100 }}">
                            <div class="team-member">
                                <img src="{{ $member['image'] }}" alt="{{ $member['name'] }}" class="img-fluid team-img">
                                <div class="team-info">
                                    <h4>{{ $member['name'] }}</h4>
                                    <p>{{ $member['position'] }}</p>
                                </div>
    ...
    <section class="section organization-section" id="organization">
        <div class="container">
            <div class="text-center mb-5" data-aos="fade-up">
                ...
                <p class="lead">{{ $organizationStructure['description'] ?? 'Our strategic organizational framework for maritime excellence' }}</p>
            </div>
                ...
                <div class="col-lg-10" data-aos="fade-up" data-aos-delay="200">
                    <div class="organization-chart-container">
                        <div class="organization-background">
                            <img src="{{ $organizationStructure['chart_image'] ?? asset('images/organization/structure.png') }}" alt="Organization Structure" class="img-fluid">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="section careers-section" id="careers">
        <div class="container">
            <div class="text-center mb-5" data-aos="fade-up">
                ...
                <p class="lead">{{ $careerData['subtitle'] ?? 'Explore exciting career opportunities in maritime excellence' }}</p>
            </div>
            ...
            <div class="row">
                @if(isset($careerData['current_openings']) && count($careerData['current_openings']) > 0)
                    @foreach($careerData['current_openings'] as $index => $job)
                        <div class="col-lg-4 col-md-6 mb-4" data-aos="fade-up" data-aos-delay="{{ ($index + 5) * 100 }}">
                            <div class="job-card">
                                ...
                                <div class="job-actions mt-3">
                                    <a href="mailto:{{ $job['contact_email'] }}" class="btn btn-sm btn-outline-primary me-2">
                                        <i class="fas fa-envelope me-1"></i> Apply
                                    </a>
                                    @if(isset($job['contact_phone']))
                                        <a href="tel:{{ str_replace(['+', ' ', '-'], '', $job['contact_phone']) }}" class="btn btn-sm btn-outline-secondary">
                ...
                @else
                    ...
                    <div class="col-12" data-aos="fade-up" data-aos-delay="500">
                        <div class="no-careers-container text-center py-5">
                            <div class="mb-4">
                                <i class="fas fa-briefcase" style="font-size: 4rem; color: var(--ocean-green); opacity: 0.3;"></i>
                            </div>
        ...
        <div class="container">
            ...
            <ul class="nav nav-pills justify-content-center activity-tabs mb-5" id="activitiesTabs" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="agency-tab" data-bs-toggle="pill" data-bs-target="#agency" type="button" role="tab" aria-controls="agency" aria-selected="true">Agency</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="cable-laying-tab" data-bs-toggle="pill" data-bs-target="#cable-laying" type="button" role="tab" aria-controls="cable-laying" aria-selected="false">Cable Laying</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="ship-to-ship-tab" data-bs-toggle="pill" data-bs-target="#ship-to-ship" type="button" role="tab" aria-controls="ship-to-ship" aria-selected="false">Ship to Ship</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="provision-supply-tab" data-bs-toggle="pill" data-bs-target="#provision-supply" type="button" role="tab" aria-controls="provision-supply" aria-selected="false">Provision Supply</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="medivac-tab" data-bs-toggle="pill" data-bs-target="#medivac" type="button" role="tab" aria-controls="medivac" aria-selected="false">Medivac Operation</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="crew-change-tab" data-bs-toggle="pill" data-bs-target="#crew-change" type="button" role="tab" aria-controls="crew-change" aria-selected="false">Crew Change</button>
                </li>
            </ul>
            ...
            <div class="tab-content" id="activitiesTabContent">
                @foreach(['agency', 'cable-laying', 'ship-to-ship', 'provision-supply', 'medivac', 'crew-change'] as $index => $category)
                    <div class="tab-pane fade {{ $index === 0 ? 'show active' : '' }}" id="{{ $category }}" role="tabpanel" aria-labelledby="{{ $category }}-tab">
                        <div class="activity-gallery">
                            @if(isset($activities[$category]) && count($activities[$category]) > 0)
                                @foreach($activities[$category] as $activityIndex => $activity)
                                    <div class="gallery-item" data-aos="fade-up" data-aos-delay="{{ ($activityIndex + 1) * 100 }}">
                                        <img src="{{ $activity['image'] }}" alt="{{ $activity['title'] }}" class="gallery-img">
                            ...
                            @else
                                <div class="col-12 text-center py-5">
                                    <div class="empty-category">
                                        <i class="fas fa-image text-muted mb-3" style="font-size: 4rem; opacity: 0.3;"></i>
                                        <h5 class="text-muted">No {{ ucfirst(str_replace('-', ' ', $category)) }} Activities</h5>
                    ...
                    <div class="col-12">
                        <div class="card shadow-lg border-0">
                            <div class="card-body p-0">
                                <div class="row g-0">
                                    <div class="col-md-5">
                                        <img src="{{ $mainOffice['image'] }}" alt="{{ $mainOffice['name'] }}" class="img-fluid h-100 w-100" style="object-fit: cover; max-height: 300px;">
                                    </div>
                                    <div class="col-md-7">
                                        <div class="p-4 p-md-5">
                                            ...
                                            <div class="contact-item mb-3">
                                                <i class="fas fa-map-marker-alt me-2" style="color: var(--ocean-green);"></i>
                                            ...
                                            @foreach($mainOffice['emails'] as $email)
                                                <div class="contact-item {{ $loop->last ? '' : 'mb-3' }}">
                                                    <i class="fas fa-envelope me-2" style="color: var(--ocean-green);"></i>
                                                    <span>{{ $email }}</span>
                                                </div>
                                            @endforeach
                                        </div>
                ...
                <div class="row mb-5" data-aos="fade-up" data-aos-delay="200">
                    <div class="col-12">
                        <div class="alert alert-info text-center">
                            ...
                            <strong>Branch information is being updated.</strong> Please check back later for our office locations.
                        </div>
                    </div>
                </div>
            @endif
    ...
    <!-- Contact CTA Section -->
    <section class="section" style="background-color: var(--dark-blue); color: white; position: relative; overflow: hidden;" id="contact">
        <div class="container">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 mb-5">
                    <img src="{{ asset('images/logo.png') }}" alt="Ship Agency Logo" class="mb-4" style="height: 60px;">
                ...
                <div class="col-lg-3 col-md-6 mb-5">
                    ...
                    <ul class="footer-links list-unstyled">
                        ...
                        @else
                            <!-- Fallback branches -->
                            <li><a href="#location"><i class="fas fa-anchor me-2"></i><strong>Surabaya</strong><br></a></li>
                            <li><a href="#location"><i class="fas fa-anchor me-2"></i><strong>Gresik</strong><br></a></li>
                            <li><a href="#location"><i class="fas fa-anchor me-2"></i><strong>Rembang</strong><br></a></li>
                            <li><a href="#location"><i class="fas fa-anchor me-2"></i><strong>Lamongan</strong><br></a></li>
                            <li><a href="#location"><i class="fas fa-anchor me-2"></i><strong>Balikpapan</strong><br></a></li>
                        @endif
                    </ul>
                </div>
            </div>
